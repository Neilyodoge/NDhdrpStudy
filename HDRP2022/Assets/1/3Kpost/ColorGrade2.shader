Shader "Hidden/Kino/PostProcess/ColorGrade2"
{
    HLSLINCLUDE
    ...
    float4 SampleInput(int2 coord)
    {
        ...
        return LOAD_TEXTURE2D_X(_InputTexture2, coord);
    }
    ...
    float4 Fragment(Varyings input) : SV_Target
    {
        ...
        float4 c = LOAD_TEXTURE2D_X(_InputTexture2, positionSS * float2(0.5,-0.5));
        return c * float4(0,0.5,0,1);//_Tint2;
